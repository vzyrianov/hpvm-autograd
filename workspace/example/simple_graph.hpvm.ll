...
entry:
  ...
  %call251 = call i8* @llvm.hpvm.grad(i8* %7, i8* %call, i32 1)
  %host_data27 = getelementptr inbounds i8, i8* %call251, i64 48
  %8 = bitcast i8* %host_data27 to float**
  %9 = load float*, float** %8, align 8, !tbaa !22
  ...
  %num_elems = getelementptr inbounds i8, i8* %call251, i64 72
  %10 = bitcast i8* %num_elems to i64*
  %11 = load i64, i64* %10, align 8, !tbaa !21
  %call29 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull %call28, i64 %11)
  ...
  %size_in_bytes = getelementptr inbounds i8, i8* %call251, i64 80
  %12 = bitcast i8* %size_in_bytes to i64*
  %13 = load i64, i64* %12, align 8, !tbaa !23
  %call32 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull %call31, i64 %13)
  ...
  %14 = load float, float* %9, align 4, !tbaa !25
  %call36 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call34, float %14)
  ...
  %arrayidx38 = getelementptr inbounds float, float* %9, i64 1
  %15 = load float, float* %arrayidx38, align 4, !tbaa !25
  %call39 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call37, float %15)
  ...
  %arrayidx41 = getelementptr inbounds float, float* %9, i64 2
  %16 = load float, float* %arrayidx41, align 4, !tbaa !25
  %call42 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call40, float %16)
  ...
  %arrayidx44 = getelementptr inbounds float, float* %9, i64 3
  %17 = load float, float* %arrayidx44, align 4, !tbaa !25
  %call45 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call43, float %17)
  ...
  %18 = load i8*, i8** %tensor, align 1, !tbaa !48
  tail call void @hpvm_request_tensor(i8* %18, i32 0)
  %host_data49 = getelementptr inbounds i8, i8* %18, i64 48
  %19 = bitcast i8* %host_data49 to float**
  %20 = load float*, float** %19, align 8, !tbaa !22
  ...
  %num_elems51 = getelementptr inbounds i8, i8* %18, i64 72
  %21 = bitcast i8* %num_elems51 to i64*
  %22 = load i64, i64* %21, align 8, !tbaa !21
  %call52 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull %call50, i64 %22)
  ...
  %size_in_bytes55 = getelementptr inbounds i8, i8* %18, i64 80
  %23 = bitcast i8* %size_in_bytes55 to i64*
  %24 = load i64, i64* %23, align 8, !tbaa !23
  %call56 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull %call54, i64 %24)
  ...
  %25 = load float, float* %20, align 4, !tbaa !25
  %call60 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call58, float %25)
  ...
  %arrayidx62 = getelementptr inbounds float, float* %20, i64 1
  %26 = load float, float* %arrayidx62, align 4, !tbaa !25
  %call63 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call61, float %26)
  ...
  %arrayidx65 = getelementptr inbounds float, float* %20, i64 2
  %27 = load float, float* %arrayidx65, align 4, !tbaa !25
  %call66 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call64, float %27)
  ...
  %arrayidx68 = getelementptr inbounds float, float* %20, i64 3
  %28 = load float, float* %arrayidx68, align 4, !tbaa !25
  %call69 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call67, float %28)
...
; Function Attrs: nounwind uwtable
define dso_local %struct.out._Z10var_0_nodePvmS_m @_Z10var_0_nodePvmS_m_cloned(i8* in %t1, i64 %bytes_t1, i8* in %t2, i64 %bytes_t2) #4 {
entry:
...
; Function Attrs: nounwind uwtable
define dso_local %struct.out._Z10var_1_nodePvm @_Z10var_1_nodePvm_cloned(i8* in %t1, i64 %bytes_t1) #4 {
entry:
  %call1 = call i8* @llvm.hpvm.tensor.relu(i8* %t1)
  %returnStruct = insertvalue %struct.out._Z10var_1_nodePvm undef, i8* %call1, 0
...
; Function Attrs: nounwind uwtable
define dso_local %struct.out._Z10var_2_nodePvm @_Z10var_2_nodePvm_cloned(i8* in %t1, i64 %bytes_t1) #4 {
entry:
...
; Function Attrs: nounwind uwtable
define dso_local %struct.out._Z4rootPvmS_m @_Z4rootPvmS_m_cloned(i8* in %input1, i64 in %input1_bytes, i8* in %input2, i64 in %input2_bytes) #4 {
entry:
  %_Z10var_0_nodePvmS_m_cloned.node = call i8* @llvm.hpvm.createNode(i8* bitcast (%struct.out._Z10var_0_nodePvmS_m (i8*, i64, i8*, i64)* @_Z10var_0_nodePvmS_m_cloned to i8*))
  call void @llvm.hpvm.bind.input(i8* %_Z10var_0_nodePvmS_m_cloned.node, i32 0, i32 0, i1 false)
  call void @llvm.hpvm.bind.input(i8* %_Z10var_0_nodePvmS_m_cloned.node, i32 1, i32 1, i1 false)
  call void @llvm.hpvm.bind.input(i8* %_Z10var_0_nodePvmS_m_cloned.node, i32 2, i32 2, i1 false)
  call void @llvm.hpvm.bind.input(i8* %_Z10var_0_nodePvmS_m_cloned.node, i32 3, i32 3, i1 false)
  %_Z10var_1_nodePvm_cloned.node = call i8* @llvm.hpvm.createNode(i8* bitcast (%struct.out._Z10var_1_nodePvm (i8*, i64)* @_Z10var_1_nodePvm_cloned to i8*))
  %output = call i8* @llvm.hpvm.createEdge(i8* %_Z10var_0_nodePvmS_m_cloned.node, i8* %_Z10var_1_nodePvm_cloned.node, i1 false, i32 0, i32 0, i1 false)
  %output1 = call i8* @llvm.hpvm.createEdge(i8* %_Z10var_0_nodePvmS_m_cloned.node, i8* %_Z10var_1_nodePvm_cloned.node, i1 false, i32 1, i32 1, i1 false)
  %_Z10var_2_nodePvm_cloned.node = call i8* @llvm.hpvm.createNode(i8* bitcast (%struct.out._Z10var_2_nodePvm (i8*, i64)* @_Z10var_2_nodePvm_cloned to i8*))
  %output2 = call i8* @llvm.hpvm.createEdge(i8* %_Z10var_1_nodePvm_cloned.node, i8* %_Z10var_2_nodePvm_cloned.node, i1 false, i32 0, i32 0, i1 false)
  %output3 = call i8* @llvm.hpvm.createEdge(i8* %_Z10var_1_nodePvm_cloned.node, i8* %_Z10var_2_nodePvm_cloned.node, i1 false, i32 1, i32 1, i1 false)
  call void @llvm.hpvm.bind.output(i8* %_Z10var_2_nodePvm_cloned.node, i32 0, i32 0, i1 false)
  call void @llvm.hpvm.bind.output(i8* %_Z10var_2_nodePvm_cloned.node, i32 1, i32 1, i1 false)
...
!2 = !{%struct.out._Z10var_0_nodePvmS_m (i8*, i64, i8*, i64)* @_Z10var_0_nodePvmS_m_cloned}
!3 = !{%struct.out._Z10var_1_nodePvm (i8*, i64)* @_Z10var_1_nodePvm_cloned}
!4 = !{%struct.out._Z10var_2_nodePvm (i8*, i64)* @_Z10var_2_nodePvm_cloned}
