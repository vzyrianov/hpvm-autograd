...
if.end:                                           ; preds = %entry, %if.then
  ...
  %2 = load i32, i32* %num_dims, align 8, !tbaa !14
  ...
  %7 = load i64, i64* %arrayidx6, align 8, !tbaa !16
...
entry:
  ...
  %0 = load i32, i32* %data_type, align 8, !tbaa !20
  %cmp = icmp eq i32 %0, 0
  br i1 %cmp, label %if.then, label %if.end
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store float 1.000000e+00, float* %arrayidx, align 4, !tbaa !21
  %inc = add i32 %i.011, 1
...
for.body11:                                       ; preds = %for.body11.preheader, %for.body11
  ...
  store float 2.000000e+00, float* %arrayidx13, align 4, !tbaa !21
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %i.011 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %for.body ]
  %arrayidx = getelementptr inbounds float, float* %2, i64 %conv12
  store float %target_value, float* %arrayidx, align 4, !tbaa !21
  %inc = add i32 %i.011, 1
  %conv = zext i32 %inc to i64
  %cmp1 = icmp ugt i64 %5, %conv
  br i1 %cmp1, label %for.body, label %if.end
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store float %conv2, float* %arrayidx, align 4, !tbaa !21
...
for.body:                                         ; preds = %if.then, %for.body
  ...
  %5 = load float, float* %arrayidx, align 4, !tbaa !21
  ...
  %inc = add i32 %i.013, 1
  %conv = zext i32 %inc to i64
  %6 = load i64, i64* %3, align 8, !tbaa !17
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %6 = load float, float* %arrayidx, align 4, !tbaa !21
  %arrayidx3 = getelementptr inbounds float, float* %3, i64 %conv19
  %7 = load float, float* %arrayidx3, align 4, !tbaa !21
...
for.body:                                         ; preds = %entry, %for.cond
  ...
  %2 = load float, float* %arrayidx, align 4, !tbaa !21
  %arrayidx2 = getelementptr inbounds float, float* %data, i64 %conv13
  %3 = load float, float* %arrayidx2, align 4, !tbaa !21
...
entry:
  ...
  %2 = load i64, i64* %1, align 8, !tbaa !16
  %arrayidx3 = getelementptr inbounds i64, i64* %1, i64 1
  %3 = load i64, i64* %arrayidx3, align 8, !tbaa !16
...
for.cond.cleanup7:                                ; preds = %for.body8, %for.cond4.preheader
  ...
  %6 = load i32, i32* %arrayidx18, align 4, !tbaa !23
...
for.body8:                                        ; preds = %for.body8.lr.ph, %for.body8
  ...
  %7 = load float, float* %arrayidx11, align 4, !tbaa !21
  %add15 = add i64 %conv5103, %mul
  %arrayidx16 = getelementptr inbounds float, float* %5, i64 %add15
  %8 = load float, float* %arrayidx16, align 4, !tbaa !21
...
if.end50:                                         ; preds = %for.cond.cleanup, %invoke.cont42
...
invoke.cont:                                      ; preds = %entry
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*], [5 x i8*] }, { [5 x i8*], [5 x i8*] }* @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 0, inrange i32 0, i64 3) to i32 (...)**), i32 (...)*** %3, align 8, !tbaa !24
  %4 = getelementptr inbounds %"class.std::basic_ios", %"class.std::basic_ios"* %1, i64 0, i32 0, i32 0
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*], [5 x i8*] }, { [5 x i8*], [5 x i8*] }* @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 0, inrange i32 1, i64 3) to i32 (...)**), i32 (...)*** %4, align 8, !tbaa !24
...
invoke.cont3:                                     ; preds = %invoke.cont
  ...
  %vtable = load i8*, i8** %5, align 8, !tbaa !24
...
entry:
  ...
  %vtable = load i8*, i8** %0, align 8, !tbaa !24
  %vbase.offset.ptr = getelementptr i8, i8* %vtable, i64 -24
...
entry:
  ...
  %0 = load i64, i64* %_M_string_length, align 8, !tbaa !26
  ret i64 %0
}
...
for.body7:                                        ; preds = %invoke.cont, %for.body7.lr.ph
  ...
  store i32 %11, i32* %index, align 4, !tbaa !31
...
if.end68:                                         ; preds = %for.cond.cleanup, %invoke.cont58
...
entry:
  ...
  %0 = load %struct.ClassProb*, %struct.ClassProb** %_M_finish, align 8, !tbaa !33
  %_M_end_of_storage = getelementptr inbounds %"class.std::vector.3", %"class.std::vector.3"* %this, i64 0, i32 0, i32 0, i32 0, i32 2
  %1 = load %struct.ClassProb*, %struct.ClassProb** %_M_end_of_storage, align 8, !tbaa !35
...
if.then:                                          ; preds = %entry
  ...
  %3 = load %struct.ClassProb*, %struct.ClassProb** %_M_finish, align 8, !tbaa !33
  %incdec.ptr = getelementptr inbounds %struct.ClassProb, %struct.ClassProb* %3, i64 1
  store %struct.ClassProb* %incdec.ptr, %struct.ClassProb** %_M_finish, align 8, !tbaa !33
  br label %if.end
...
entry:
  %_M_start = getelementptr inbounds %"class.std::vector.3", %"class.std::vector.3"* %this, i64 0, i32 0, i32 0, i32 0, i32 0
  %0 = load %struct.ClassProb*, %struct.ClassProb** %_M_start, align 8, !tbaa !36
...
entry:
  %0 = getelementptr inbounds %"class.std::vector.3", %"class.std::vector.3"* %this, i64 0, i32 0
  %_M_start = getelementptr inbounds %"class.std::vector.3", %"class.std::vector.3"* %this, i64 0, i32 0, i32 0, i32 0, i32 0
  %1 = load %struct.ClassProb*, %struct.ClassProb** %_M_start, align 8, !tbaa !36
  %_M_finish = getelementptr inbounds %"class.std::vector.3", %"class.std::vector.3"* %this, i64 0, i32 0, i32 0, i32 0, i32 1
  %2 = load %struct.ClassProb*, %struct.ClassProb** %_M_finish, align 8, !tbaa !33
...
entry:
  ...
  %ss = alloca %"class.std::__cxx11::basic_ostringstream", align 8
  %print_str = alloca %"class.std::__cxx11::basic_string", align 8
  store float %accuracy, float* %accuracy.addr, align 4, !tbaa !21
...
invoke.cont:                                      ; preds = %if.then
  %2 = load float, float* %accuracy.addr, align 4, !tbaa !21
...
if.then:                                          ; preds = %entry
  ...
  %3 = load float*, float** %_M_finish, align 8, !tbaa !7
  %incdec.ptr = getelementptr inbounds float, float* %3, i64 1
  store float* %incdec.ptr, float** %_M_finish, align 8, !tbaa !7
  br label %if.end
...
for.body:                                         ; preds = %for.body.lr.ph, %invoke.cont9
  ...
  %3 = load float, float* %call4, align 4, !tbaa !21
  call void @llvm.lifetime.start.p0i8(i64 376, i8* nonnull %0) #20
  call void @_ZNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEC1Ev(%"class.std::__cxx11::basic_ostringstream"* nonnull %ss)
...
entry:
  %_M_start = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %this, i64 0, i32 0, i32 0, i32 0, i32 0
  %0 = load float*, float** %_M_start, align 8, !tbaa !2
...
entry:
  ...
  %4 = load i64, i64* %arrayidx2, align 8, !tbaa !16
  %arrayidx3 = getelementptr inbounds i64, i64* %2, i64 2
  %5 = load i64, i64* %arrayidx3, align 8, !tbaa !16
  %mul = mul i64 %5, %4
  %arrayidx4 = getelementptr inbounds i64, i64* %2, i64 3
  %6 = load i64, i64* %arrayidx4, align 8, !tbaa !16
  %mul5 = mul i64 %mul, %6
...
for.cond.cleanup14:                               ; preds = %for.body15, %for.body
  ...
  store float %mul32, float* %psnr, align 4, !tbaa !21
...
for.body15:                                       ; preds = %for.body, %for.body15
  ...
  %15 = load float, float* %arrayidx16, align 4, !tbaa !21
  %arrayidx18 = getelementptr inbounds float, float* %10, i64 %add
  %16 = load float, float* %arrayidx18, align 4, !tbaa !21
...
invoke.cont45:                                    ; preds = %invoke.cont43
  %20 = load float, float* %psnr, align 4, !tbaa !21
...
for.body96:                                       ; preds = %invoke.cont89, %for.body96
  ...
  %40 = load float, float* %call97, align 4, !tbaa !21
  ...
  %41 = load float, float* %call99, align 4, !tbaa !21
...
ehcleanup122:                                     ; preds = %lpad88, %lpad108, %lpad81, %ehcleanup60
...
; Function Attrs: nounwind uwtable
define dso_local void @_Z10var_0_nodePvmS_m(i8* %t1, i64 %bytes_t1, i8* %t2, i64 %bytes_t2) #4 {
entry:
  tail call void @__hpvm__hint(i32 4) #20
  tail call void (i32, ...) @__hpvm__attributes(i32 2, i8* %t1, i8* %t2, i32 0) #20
  %call = tail call i8* @__hpvm__tensor_add(i8* %t1, i8* %t2) #20
  tail call void (i32, ...) @__hpvm__return(i32 2, i8* %call, i64 0) #20
  ret void
}

; Function Attrs: nounwind
declare dso_local void @__hpvm__hint(i32) local_unnamed_addr #2

; Function Attrs: nounwind
declare dso_local void @__hpvm__attributes(i32, ...) local_unnamed_addr #2

; Function Attrs: nounwind
declare dso_local i8* @__hpvm__tensor_add(i8*, i8*) local_unnamed_addr #2

; Function Attrs: nounwind
declare dso_local void @__hpvm__return(i32, ...) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define dso_local void @_Z10var_1_nodePvm(i8* %t1, i64 %bytes_t1) #4 {
entry:
  tail call void @__hpvm__hint(i32 4) #20
  tail call void (i32, ...) @__hpvm__attributes(i32 1, i8* %t1, i32 0) #20
  %call = tail call i8* @__hpvm__tensor_relu(i8* %t1) #20
  tail call void (i32, ...) @__hpvm__return(i32 2, i8* %call, i64 0) #20
  ret void
}

; Function Attrs: nounwind
declare dso_local i8* @__hpvm__tensor_relu(i8*) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define dso_local void @_Z10var_2_nodePvm(i8* %t1, i64 %bytes_t1) #4 {
entry:
  tail call void @__hpvm__hint(i32 4) #20
  tail call void (i32, ...) @__hpvm__attributes(i32 1, i8* %t1, i32 0) #20
  %call = tail call i8* @__hpvm__tensor_tanh(i8* %t1) #20
  tail call void (i32, ...) @__hpvm__return(i32 2, i8* %call, i64 0) #20
  ret void
}

; Function Attrs: nounwind
declare dso_local i8* @__hpvm__tensor_tanh(i8*) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define dso_local void @_Z4rootPvmS_m(i8* %input1, i64 %input1_bytes, i8* %input2, i64 %input2_bytes) #4 {
entry:
  tail call void @__hpvm__hint(i32 1) #20
  tail call void (i32, ...) @__hpvm__attributes(i32 4, i8* %input1, i64 %input1_bytes, i8* %input2, i64 %input2_bytes, i32 0) #20
  %call = tail call i8* (i32, ...) @__hpvm__createNodeND(i32 0, void (i8*, i64, i8*, i64)* nonnull @_Z10var_0_nodePvmS_m) #20
  ...
  tail call void @__hpvm__bindIn(i8* %call, i32 3, i32 3, i32 0) #20
  %call1 = tail call i8* (i32, ...) @__hpvm__createNodeND(i32 0, void (i8*, i64)* nonnull @_Z10var_1_nodePvm) #20
  %call2 = tail call i8* @__hpvm__edge(i8* %call, i8* %call1, i32 0, i32 0, i32 0, i32 0) #20
  %call3 = tail call i8* @__hpvm__edge(i8* %call, i8* %call1, i32 0, i32 1, i32 1, i32 0) #20
  %call4 = tail call i8* (i32, ...) @__hpvm__createNodeND(i32 0, void (i8*, i64)* nonnull @_Z10var_2_nodePvm) #20
  %call5 = tail call i8* @__hpvm__edge(i8* %call1, i8* %call4, i32 0, i32 0, i32 0, i32 0) #20
  %call6 = tail call i8* @__hpvm__edge(i8* %call1, i8* %call4, i32 0, i32 1, i32 1, i32 0) #20
  tail call void @__hpvm__bindOut(i8* %call4, i32 0, i32 0, i32 0) #20
  tail call void @__hpvm__bindOut(i8* %call4, i32 1, i32 1, i32 0) #20
  ret void
}

; Function Attrs: nounwind
declare dso_local i8* @__hpvm__createNodeND(i32, ...) local_unnamed_addr #2

; Function Attrs: nounwind
declare dso_local void @__hpvm__bindIn(i8*, i32, i32, i32) local_unnamed_addr #2

; Function Attrs: nounwind
declare dso_local i8* @__hpvm__edge(i8*, i8*, i32, i32, i32, i32) local_unnamed_addr #2

; Function Attrs: nounwind
declare dso_local void @__hpvm__bindOut(i8*, i32, i32, i32) local_unnamed_addr #2
...
entry:
  ...
  store float 0.000000e+00, float* %arrayidx3, align 4, !tbaa !21
  %arrayidx4 = getelementptr inbounds float, float* %2, i64 2
  store float -1.000000e+00, float* %arrayidx4, align 4, !tbaa !21
  %arrayidx5 = getelementptr inbounds float, float* %2, i64 3
  store float 0.000000e+00, float* %arrayidx5, align 4, !tbaa !21
  ...
  store i8* %call6, i8** %3, align 1, !tbaa !42
  %input2_bytes = getelementptr inbounds i8, i8* %call, i64 24
  %4 = bitcast i8* %input2_bytes to i64*
  store i64 0, i64* %4, align 1, !tbaa !43
  %host_data9 = getelementptr inbounds i8, i8* %call6, i64 48
  %5 = bitcast i8* %host_data9 to float**
  %6 = load float*, float** %5, align 8, !tbaa !18
  store float 0xBFE3333340000000, float* %6, align 4, !tbaa !21
  %arrayidx11 = getelementptr inbounds float, float* %6, i64 1
  store float 0x4002666660000000, float* %arrayidx11, align 4, !tbaa !21
  %arrayidx12 = getelementptr inbounds float, float* %6, i64 2
  store float 0.000000e+00, float* %arrayidx12, align 4, !tbaa !21
  %arrayidx13 = getelementptr inbounds float, float* %6, i64 3
  store float 0.000000e+00, float* %arrayidx13, align 4, !tbaa !21
  ...
  %call25 = tail call i8* (...) @__hpvm__grad(void (i8*, i64, i8*, i64)* nonnull @_Z4rootPvmS_m, i8* %call, i32 1) #20
  %host_data27 = getelementptr inbounds i8, i8* %call25, i64 48
  %7 = bitcast i8* %host_data27 to float**
  %8 = load float*, float** %7, align 8, !tbaa !18
  ...
  %num_elems = getelementptr inbounds i8, i8* %call25, i64 72
  %9 = bitcast i8* %num_elems to i64*
  %10 = load i64, i64* %9, align 8, !tbaa !17
  %call29 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull %call28, i64 %10)
  ...
  %size_in_bytes = getelementptr inbounds i8, i8* %call25, i64 80
  %11 = bitcast i8* %size_in_bytes to i64*
  %12 = load i64, i64* %11, align 8, !tbaa !19
  %call32 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull %call31, i64 %12)
  ...
  %13 = load float, float* %8, align 4, !tbaa !21
  %call36 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call34, float %13)
  ...
  %arrayidx38 = getelementptr inbounds float, float* %8, i64 1
  %14 = load float, float* %arrayidx38, align 4, !tbaa !21
  %call39 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call37, float %14)
  ...
  %arrayidx41 = getelementptr inbounds float, float* %8, i64 2
  %15 = load float, float* %arrayidx41, align 4, !tbaa !21
  %call42 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call40, float %15)
  ...
  %arrayidx44 = getelementptr inbounds float, float* %8, i64 3
  %16 = load float, float* %arrayidx44, align 4, !tbaa !21
  %call45 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call43, float %16)
  ...
  tail call void @__hpvm__init() #20
  tail call void @startMemTracking()
  %call47 = tail call i8* (i32, ...) @__hpvm__launch(i32 0, void (i8*, i64, i8*, i64)* nonnull @_Z4rootPvmS_m, i8* %call) #20
  tail call void @__hpvm__wait(i8* %call47) #20
  %r = getelementptr inbounds i8, i8* %call, i64 32
  %tensor = bitcast i8* %r to i8**
  %17 = load i8*, i8** %tensor, align 1, !tbaa !44
  tail call void @hpvm_request_tensor(i8* %17, i32 0)
  %host_data49 = getelementptr inbounds i8, i8* %17, i64 48
  %18 = bitcast i8* %host_data49 to float**
  ...
  %num_elems51 = getelementptr inbounds i8, i8* %17, i64 72
  %20 = bitcast i8* %num_elems51 to i64*
  %21 = load i64, i64* %20, align 8, !tbaa !17
  %call52 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull %call50, i64 %21)
  ...
  %size_in_bytes55 = getelementptr inbounds i8, i8* %17, i64 80
  %22 = bitcast i8* %size_in_bytes55 to i64*
  %23 = load i64, i64* %22, align 8, !tbaa !19
  %call56 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull %call54, i64 %23)
  ...
  %24 = load float, float* %19, align 4, !tbaa !21
  %call60 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call58, float %24)
  ...
  %arrayidx62 = getelementptr inbounds float, float* %19, i64 1
  %25 = load float, float* %arrayidx62, align 4, !tbaa !21
  %call63 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call61, float %25)
  ...
  %arrayidx65 = getelementptr inbounds float, float* %19, i64 2
  %26 = load float, float* %arrayidx65, align 4, !tbaa !21
  %call66 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call64, float %26)
  ...
  %arrayidx68 = getelementptr inbounds float, float* %19, i64 3
  %27 = load float, float* %arrayidx68, align 4, !tbaa !21
  %call69 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* nonnull %call67, float %27)
  ...
  tail call void @__hpvm__cleanup() #20
  ret i32 0
}
...
; Function Attrs: nounwind
declare dso_local i8* @__hpvm__grad(...) local_unnamed_addr #2
...
; Function Attrs: nounwind
declare dso_local void @__hpvm__init() local_unnamed_addr #2

declare dso_local void @startMemTracking() local_unnamed_addr #1

; Function Attrs: nounwind
declare dso_local i8* @__hpvm__launch(i32, ...) local_unnamed_addr #2

; Function Attrs: nounwind
declare dso_local void @__hpvm__wait(i8*) local_unnamed_addr #2

; Function Attrs: nounwind
declare dso_local void @__hpvm__cleanup() local_unnamed_addr #2
...
entry:
  ...
  %0 = load i32, i32* %_M_flags, align 8, !tbaa !45
...
entry:
  %0 = load i32, i32* %__a, align 4, !tbaa !51
  %call = tail call i32 @_ZStanSt13_Ios_FmtflagsS_(i32 %0, i32 %__b)
  store i32 %call, i32* %__a, align 4, !tbaa !51
  ret i32* %__a
}
...
entry:
  ...
  %0 = load i8*, i8** %_M_p, align 8, !tbaa !52
  ret i8* %0
}
...
if.then:                                          ; preds = %entry
  ...
  %0 = load i64, i64* %_M_allocated_capacity, align 8, !tbaa !32
...
entry:
  ...
  store i8* %__dat, i8** %_M_p, align 8, !tbaa !53
  ret void
}
...
if.end:                                           ; preds = %entry
  ...
  store i64 %call2, i64* %__dnew, align 8, !tbaa !16
...
if.then4:                                         ; preds = %if.end
  ...
  %1 = load i64, i64* %__dnew, align 8, !tbaa !16
...
if.end6:                                          ; preds = %if.then4, %if.end
  ...
  %2 = load i64, i64* %__dnew, align 8, !tbaa !16
...
entry:
  ...
  store i8* %__first, i8** %__first.addr, align 8, !tbaa !54
...
entry:
  %_M_p = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %this, i64 0, i32 0, i32 0
  store i8* %__p, i8** %_M_p, align 8, !tbaa !52
  ret void
}
...
entry:
  %_M_allocated_capacity = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %this, i64 0, i32 2, i32 0
  store i64 %__capacity, i64* %_M_allocated_capacity, align 8, !tbaa !32
  ret void
}
...
entry:
  ...
  store i8 0, i8* %ref.tmp, align 1, !tbaa !32
...
entry:
  %0 = load i8, i8* %__c2, align 1, !tbaa !32
  store i8 %0, i8* %__c1, align 1, !tbaa !32
  ret void
}
...
entry:
  %_M_string_length = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %this, i64 0, i32 1
  store i64 %__length, i64* %_M_string_length, align 8, !tbaa !26
  ret void
}
...
entry:
  ...
  %2 = load i64, i64* %1, align 8, !tbaa !37
...
entry:
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [4 x i8*] }, { [4 x i8*] }* @_ZTVSt9basic_iosIcSt11char_traitsIcEE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %1, align 8, !tbaa !24
  %_M_tie = getelementptr inbounds %"class.std::basic_ios", %"class.std::basic_ios"* %this, i64 0, i32 1
  store %"class.std::basic_ostream"* null, %"class.std::basic_ostream"** %_M_tie, align 8, !tbaa !55
  %_M_fill = getelementptr inbounds %"class.std::basic_ios", %"class.std::basic_ios"* %this, i64 0, i32 2
  store i8 0, i8* %_M_fill, align 8, !tbaa !58
  %_M_fill_init = getelementptr inbounds %"class.std::basic_ios", %"class.std::basic_ios"* %this, i64 0, i32 3
  store i8 0, i8* %_M_fill_init, align 1, !tbaa !59
...
entry:
  ...
  store i64 %5, i64* %9, align 8, !tbaa !24
  %vtable3 = load i8*, i8** %6, align 8, !tbaa !24
...
entry:
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [16 x i8*] }, { [16 x i8*] }* @_ZTVNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %1, align 8, !tbaa !24
  %_M_mode = getelementptr inbounds %"class.std::__cxx11::basic_stringbuf", %"class.std::__cxx11::basic_stringbuf"* %this, i64 0, i32 1
  store i32 %__mode, i32* %_M_mode, align 8, !tbaa !60
...
entry:
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [16 x i8*] }, { [16 x i8*] }* @_ZTVNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %0, align 8, !tbaa !24
  %_M_string = getelementptr inbounds %"class.std::__cxx11::basic_stringbuf", %"class.std::__cxx11::basic_stringbuf"* %this, i64 0, i32 2
...
entry:
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [16 x i8*] }, { [16 x i8*] }* @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %0, align 8, !tbaa !24
...
entry:
  ...
  store i64 %5, i64* %8, align 8, !tbaa !24
  %_M_stringbuf = getelementptr inbounds %"class.std::__cxx11::basic_ostringstream", %"class.std::__cxx11::basic_ostringstream"* %this, i64 0, i32 1
  tail call void @_ZNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEED2Ev(%"class.std::__cxx11::basic_stringbuf"* nonnull %_M_stringbuf) #20
...
nrvo.skipdtor:                                    ; preds = %if.else, %if.then6, %if.else19
  ret void
}
...
entry:
  ...
  %0 = load i8*, i8** %_M_out_cur, align 8, !tbaa !63
  ret i8* %0
}
...
entry:
  ...
  %0 = load i8*, i8** %_M_in_end, align 8, !tbaa !65
  ret i8* %0
}
...
entry:
  ...
  %0 = load i8*, i8** %_M_out_beg, align 8, !tbaa !66
  ret i8* %0
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %0) #20
  %call = tail call i8* @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_M_dataEv(%"class.std::__cxx11::basic_string"* %this)
  store i8* %call, i8** %ref.tmp, align 8, !tbaa !54
...
entry:
  ...
  %1 = load i64, i64* %0, align 8, !tbaa !54
  %2 = bitcast %"class.__gnu_cxx::__normal_iterator.8"* %this to i64*
  store i64 %1, i64* %2, align 8, !tbaa !67
  ret void
}
...
entry:
  ...
  store i8* %add.ptr, i8** %ref.tmp, align 8, !tbaa !54
  call void @_ZN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEC2ERKS1_(%"class.__gnu_cxx::__normal_iterator.9"* nonnull %retval, i8** nonnull dereferenceable(8) %ref.tmp) #20
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %0) #20
  %coerce.dive = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator.9", %"class.__gnu_cxx::__normal_iterator.9"* %retval, i64 0, i32 0
  %1 = load i8*, i8** %coerce.dive, align 8
...
entry:
  ...
  store i64 %1, i64* %2, align 8, !tbaa !69
  ret void
}
...
entry:
  ...
  %2 = load i64, i64* %1, align 8, !tbaa !35
...
entry:
  ...
  %5 = load %struct.ClassProb*, %struct.ClassProb** %call9, align 8, !tbaa !54
  ...
  %6 = load %struct.ClassProb*, %struct.ClassProb** %call12, align 8, !tbaa !54
  ...
  store %struct.ClassProb* %call6, %struct.ClassProb** %_M_start, align 8, !tbaa !36
  store %struct.ClassProb* %call14, %struct.ClassProb** %_M_finish, align 8, !tbaa !33
  %add.ptr20 = getelementptr inbounds %struct.ClassProb, %struct.ClassProb* %call6, i64 %call
  store %struct.ClassProb* %add.ptr20, %struct.ClassProb** %_M_end_of_storage, align 8, !tbaa !35
  ret void
}
...
if.end:                                           ; preds = %entry
  ...
  store i64 %call4, i64* %ref.tmp, align 8, !tbaa !16
  ...
  %1 = load i64, i64* %call5, align 8, !tbaa !16
  %add = add i64 %1, %call3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %0) #20
...
entry:
  ...
  %1 = load i64, i64* %0, align 8, !tbaa !33
...
entry:
  %0 = load i64, i64* %__a, align 8, !tbaa !16
  %1 = load i64, i64* %__b, align 8, !tbaa !16
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %0) #20
  store i64 1152921504606846975, i64* %__diffmax, align 8, !tbaa !16
  ...
  store i64 %call, i64* %__allocmax, align 8, !tbaa !16
  ...
  %2 = load i64, i64* %call1, align 8, !tbaa !16
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %1) #20
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %0) #20
  ret i64 %2
}
...
entry:
  %0 = load i64, i64* %__b, align 8, !tbaa !16
  %1 = load i64, i64* %__a, align 8, !tbaa !16
  %cmp = icmp ult i64 %0, %1
  %__b.__a = select i1 %cmp, i64* %__b, i64* %__a
  ret i64* %__b.__a
}
...
entry:
  ...
  store i1 (i64, i64)* %__comp, i1 (i64, i64)** %__comp.addr, align 8, !tbaa !54
  ...
  %0 = load i1 (i64, i64)*, i1 (i64, i64)** %call, align 8, !tbaa !54
...
entry:
  %call = tail call dereferenceable(8) %struct.ClassProb** @_ZNK9__gnu_cxx17__normal_iteratorIP9ClassProbSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* nonnull %__lhs) #20
  %0 = load %struct.ClassProb*, %struct.ClassProb** %call, align 8, !tbaa !54
  %call1 = tail call dereferenceable(8) %struct.ClassProb** @_ZNK9__gnu_cxx17__normal_iteratorIP9ClassProbSt6vectorIS1_SaIS1_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"* nonnull %__rhs) #20
  %1 = load %struct.ClassProb*, %struct.ClassProb** %call1, align 8, !tbaa !54
...
entry:
  %0 = tail call i64 @llvm.ctlz.i64(i64 %__n, i1 true), !range !73
  %sub = xor i64 %0, 63
  ret i64 %sub
}
...
entry:
  ...
  %0 = load i1 (i64, i64)*, i1 (i64, i64)** %_M_comp, align 8, !tbaa !74
...
entry:
  %_M_current = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %this, i64 0, i32 0
  %0 = load %struct.ClassProb*, %struct.ClassProb** %_M_current, align 8, !tbaa !71
  %incdec.ptr = getelementptr inbounds %struct.ClassProb, %struct.ClassProb* %0, i64 1
  store %struct.ClassProb* %incdec.ptr, %struct.ClassProb** %_M_current, align 8, !tbaa !71
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %0) #20
  %_M_current = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %this, i64 0, i32 0
  %1 = load %struct.ClassProb*, %struct.ClassProb** %_M_current, align 8, !tbaa !71
  %add.ptr = getelementptr inbounds %struct.ClassProb, %struct.ClassProb* %1, i64 %__n
  store %struct.ClassProb* %add.ptr, %struct.ClassProb** %ref.tmp, align 8, !tbaa !54
...
entry:
  ...
  store i64 %1, i64* %2, align 8, !tbaa !76
  ret void
}
...
entry:
  ...
  %0 = load i1 (i64, i64)*, i1 (i64, i64)** %_M_comp, align 8, !tbaa !76
...
while.body17:                                     ; preds = %while.end, %while.body17
...
for.end:                                          ; preds = %entry, %for.cond.cleanup
  ret void
}
...
entry:
  ...
  %6 = load i64, i64* %4, align 8, !tbaa !54
  store i64 %6, i64* %5, align 8, !tbaa !54
...
while.body:                                       ; preds = %entry, %while.body
  ...
  store i64 %10, i64* %4, align 8, !tbaa !54
...
entry:
  ...
  store i64 %1, i64* %2, align 8, !tbaa !74
  ret void
}
...
entry:
  ...
  %5 = load float*, float** %call9, align 8, !tbaa !54
  ...
  %6 = load float*, float** %call12, align 8, !tbaa !54
  ...
  store float* %call6, float** %_M_start, align 8, !tbaa !2
  store float* %call14, float** %_M_finish, align 8, !tbaa !7
  %add.ptr20 = getelementptr inbounds float, float* %call6, i64 %call
  store float* %add.ptr20, float** %_M_end_of_storage, align 8, !tbaa !37
  ret void
}
...
entry:
  ...
  %0 = bitcast i64* %__diffmax to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %0) #20
  store i64 2305843009213693951, i64* %__diffmax, align 8, !tbaa !16
  %1 = bitcast i64* %__allocmax to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %1) #20
...
entry:
  ...
  %0 = load i32, i32* %_M_streambuf_state, align 8, !tbaa !82
  ret i32 %0
}
...
entry:
  ...
  %0 = load %"class.std::ctype"*, %"class.std::ctype"** %_M_ctype, align 8, !tbaa !83
...
entry:
  ...
  %0 = load i8, i8* %_M_widen_ok, align 8, !tbaa !84
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, i8* %arrayidx, align 1, !tbaa !32
  br label %return
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %2, align 8, !tbaa !24
...
!7 = !{!3, !4, i64 8}
!8 = !{!9, !4, i64 56}
!9 = !{!"_ZTS6Tensor", !10, i64 0, !10, i64 4, !10, i64 8, !11, i64 12, !4, i64 16, !4, i64 24, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !12, i64 72, !12, i64 80, !13, i64 88}
!10 = !{!"int", !5, i64 0}
!11 = !{!"_ZTS15data_location_t", !5, i64 0}
!12 = !{!"long", !5, i64 0}
!13 = !{!"_ZTS9Dimension", !10, i64 0, !4, i64 8}
!14 = !{!9, !10, i64 88}
!15 = !{!9, !4, i64 96}
!16 = !{!12, !12, i64 0}
!17 = !{!9, !12, i64 72}
...
!26 = !{!27, !12, i64 8}
!27 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !28, i64 0, !12, i64 8, !5, i64 16}
!28 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !4, i64 0}
!29 = !{!30, !22, i64 0}
!30 = !{!"_ZTS9ClassProb", !22, i64 0, !10, i64 4}
!31 = !{!30, !10, i64 4}
!32 = !{!5, !5, i64 0}
!33 = !{!34, !4, i64 8}
!34 = !{!"_ZTSNSt12_Vector_baseI9ClassProbSaIS0_EE17_Vector_impl_dataE", !4, i64 0, !4, i64 8, !4, i64 16}
!35 = !{!34, !4, i64 16}
!36 = !{!34, !4, i64 0}
!37 = !{!3, !4, i64 16}
!38 = !{!39, !4, i64 0}
!39 = !{!"_ZTS6RootIn", !4, i64 0, !12, i64 8, !4, i64 16, !12, i64 24, !40, i64 32}
!40 = !{!"_ZTS5ret_t", !4, i64 0, !12, i64 8}
!41 = !{!39, !12, i64 8}
!42 = !{!39, !4, i64 16}
!43 = !{!39, !12, i64 24}
!44 = !{!39, !4, i64 32}
!45 = !{!46, !47, i64 24}
!46 = !{!"_ZTSSt8ios_base", !12, i64 8, !12, i64 16, !47, i64 24, !48, i64 28, !48, i64 32, !4, i64 40, !49, i64 48, !5, i64 64, !10, i64 192, !4, i64 200, !50, i64 208}
!47 = !{!"_ZTSSt13_Ios_Fmtflags", !5, i64 0}
!48 = !{!"_ZTSSt12_Ios_Iostate", !5, i64 0}
!49 = !{!"_ZTSNSt8ios_base6_WordsE", !4, i64 0, !12, i64 8}
...
!54 = !{!4, !4, i64 0}
!55 = !{!56, !4, i64 216}
!56 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !4, i64 216, !5, i64 224, !57, i64 225, !4, i64 232, !4, i64 240, !4, i64 248, !4, i64 256}
!57 = !{!"bool", !5, i64 0}
!58 = !{!56, !5, i64 224}
!59 = !{!56, !57, i64 225}
!60 = !{!61, !62, i64 64}
!61 = !{!"_ZTSNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE", !62, i64 64, !27, i64 72}
!62 = !{!"_ZTSSt13_Ios_Openmode", !5, i64 0}
!63 = !{!64, !4, i64 40}
!64 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !4, i64 8, !4, i64 16, !4, i64 24, !4, i64 32, !4, i64 40, !4, i64 48, !50, i64 56}
!65 = !{!64, !4, i64 24}
!66 = !{!64, !4, i64 32}
!67 = !{!68, !4, i64 0}
!68 = !{!"_ZTSN9__gnu_cxx17__normal_iteratorIPKcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE", !4, i64 0}
!69 = !{!70, !4, i64 0}
!70 = !{!"_ZTSN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE", !4, i64 0}
!71 = !{!72, !4, i64 0}
!72 = !{!"_ZTSN9__gnu_cxx17__normal_iteratorIP9ClassProbSt6vectorIS1_SaIS1_EEEE", !4, i64 0}
!73 = !{i64 0, i64 65}
!74 = !{!75, !4, i64 0}
!75 = !{!"_ZTSN9__gnu_cxx5__ops15_Iter_comp_iterIPFb9ClassProbS2_EEE", !4, i64 0}
!76 = !{!77, !4, i64 0}
!77 = !{!"_ZTSN9__gnu_cxx5__ops14_Iter_comp_valIPFb9ClassProbS2_EEE", !4, i64 0}
!78 = !{!79, !4, i64 0}
!79 = !{!"_ZTSN9__gnu_cxx5__ops14_Val_comp_iterIPFb9ClassProbS2_EEE", !4, i64 0}
!80 = !{!81, !4, i64 0}
!81 = !{!"_ZTSN9__gnu_cxx17__normal_iteratorIPfSt6vectorIfSaIfEEEE", !4, i64 0}
!82 = !{!46, !48, i64 32}
!83 = !{!56, !4, i64 240}
!84 = !{!85, !5, i64 56}
!85 = !{!"_ZTSSt5ctypeIcE", !4, i64 16, !57, i64 24, !4, i64 32, !4, i64 40, !4, i64 48, !5, i64 56, !5, i64 57, !5, i64 313, !5, i64 569}
